...
"")
        ...
        self.logField.setGeometry(QtCore.QRect(0, 80, 731, 631))
        self.logField.setObjectName("logField")
        self.widget1 = QtWidgets.QWidget(self.logPage)
        self.widget1.setGeometry(QtCore.QRect(220, 10, 316, 51))
        self.widget1.setObjectName("widget1")
        self.gridLayout_3 = QtWidgets.QGridLayout(self.widget1)
        self.gridLayout_3.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_3.setObjectName("gridLayout_3")
        self.btnClearLog = QtWidgets.QPushButton(self.widget1)
        self.btnClearLog.setObjectName("btnClearLog")
        self.gridLayout_3.addWidget(self.btnClearLog, 0, 0, 1, 1)
        self.btnBackup = QtWidgets.QPushButton(self.widget1)
...
"")
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(210, 210, 331, 91))
        self.layoutWidget.setObjectName("layoutWidget")
        self.gridLayout_2 = QtWidgets.QGridLayout(self.layoutWidget)
        self.gridLayout_2.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.btnImpExcel = QtWidgets.QPushButton(self.layoutWidget)
        font = QtGui.QFont()
        font.setFamily("Poppins")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.gridLayout_2.addWidget(self.btnImpExcel, 0, 0, 1, 1)
        self.btnDownloadExcel = QtWidgets.QPushButton(self.layoutWidget)
        font = QtGui.QFont()
        font.setFamily("Poppins")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.gridLayout_2.addWidget(self.btnDownloadExcel, 0, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnDownloadExcel.setText(_translate("MainWindow", "Downloda reference file"))
